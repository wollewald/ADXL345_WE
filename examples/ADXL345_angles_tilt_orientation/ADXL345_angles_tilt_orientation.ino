...
*
* This sketch shows how to measure angles, tilts and orientation of the ADXL345 
...
/* In this next step the offset for angles is corrected to get quite precise tilt 
 *  values for x and y up to ~60°. The additional offsetCorrection is only for tilt
 *  measurements.
*/
...
/* Angles use the corrected slope but no offsets */
...
/* Tilts use corrected slope and offsets */
  Serial.print("Tilt x = ");
  Serial.print(tilt.x);
  Serial.print("  |  Tilt y   = ");
  Serial.print(tilt.y);
  Serial.print("  |  Tilt z   = ");
  Serial.println(tilt.z);
